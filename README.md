...
- **Four monuments** — Khufu (exterior, cutaway interior, fly-through), Khafre (surviving casing cap, the two entrances, Belzoni's chamber, valley temple, the Osiris Shaft), Menkaure (granite jacket frozen mid-dressing, the 1196 CE demolition gash, the sarcophagus lost at sea, Reisner's triads, the G3 queens), and a sculpted Great Sphinx (smooth-shaded bedrock body with nemes headdress, repair-masonry forelegs, enclosure, sand-burial through the ages, **Erosion Lab** that paints Schoch's rain-runoff reading vs the wind-and-salt consensus onto the enclosure walls). Every pyramid has base/height/slope measurement overlays, camera presets, hotspots and interior fly-throughs.
...
- **Knowledge Vault** — 13 searchable, filterable entries with key-facts tables, sources, Wikimedia Commons galleries (with lightbox), and localStorage bookmarks.
